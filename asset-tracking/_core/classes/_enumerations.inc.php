 ...
 */
 ...
 /**
 * Defines constants for framework exceptions
...
abstract class Exceptions {
	...
	const ILLEGAL_CONTROL_ID = 6022;
	const CONTROL_EXISTS = 6023;
	const INVALID_CONTROL_PARENT_OBJECT = 6024;

	// other
	const FUNCTION_NOT_IMPLEMENTED = 7000;
}

/**
 * Defines constants for HTTP response codes
 * @package org.sugarfish.core
 * @abstract
 * @name HttpResponse
 */
...
abstract class Layout {
	...
	/**
	 * Default Layout, renders template as normal with Header and Footer
	 */
	const NotSet = 'NotSet';

	/**
	 * Renders the template without Header or Footer
	 */
	const Plain = 'Plain';

	/**
	 * Omits rendering of the template completely, for downloads or redirects, etc.
	 */
	const None = 'None';
}

/**
 * Defines constants for query string tags
 * @package org.sugarfish.core
 * @abstract
 * @name WebsiteQSTags
 */
...
/**
 * Defines constants for time in seconds for common durations
 * @package org.sugarfish.core
 * @abstract
 * @name SecondsIn
 */
