...
abstract class MimeType {
	 ...
	 * @access public
	 * @var string $strMagicDatabaseFilePath
	 */
	public static $strMagicDatabaseFilePath = '/etc/apache2/magic';
	...
	public static function GetMimeTypeForFile($strFilePath) {
		...
		if (class_exists('finfo')) {
			if (MimeType::$strMagicDatabaseFilePath)
				$objFileInfo = new finfo(FILEINFO_MIME, MimeType::$strMagicDatabaseFilePath);
			else
